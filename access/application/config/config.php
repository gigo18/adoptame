 ...
 */
define('URL', 'http://localhost/adoptame/access/');
...
// name of your host
define("EMAIL_SMTP_HOST", 'mx1.hostinger.mx');
// leave this true until your SMTP can be used without login
define("EMAIL_SMTP_AUTH", true);
// SMTP provider username
define("EMAIL_SMTP_USERNAME", 'info@adoptme.esy.es');
// SMTP provider password
define("EMAIL_SMTP_PASSWORD", 'wright.23');
// SMTP provider port
...
define("EMAIL_PASSWORD_RESET_FROM_EMAIL", "info@adoptme.esy.es");
define("EMAIL_PASSWORD_RESET_FROM_NAME", "Proyecto Adoptame :3");
define("EMAIL_PASSWORD_RESET_SUBJECT", "Resetear contraseña Adoptame");
define("EMAIL_PASSWORD_RESET_CONTENT", "Por favor haga click en el siguiente vinculo para resetear su contraseña: ");

define("EMAIL_VERIFICATION_URL", URL . "login/verify");
define("EMAIL_VERIFICATION_FROM_EMAIL", "info@adoptme.esy.es");
define("EMAIL_VERIFICATION_FROM_NAME", "Adoptame");
define("EMAIL_VERIFICATION_SUBJECT", "Activar su cuenta en Adoptame");
define("EMAIL_VERIFICATION_CONTENT", "Por favor haga click en el siguiente link para activar su cuenta: ");
